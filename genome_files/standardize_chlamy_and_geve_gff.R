...
# For genes, set ID as group and Parent as NA and add gene_id
...
# Sort CDS and append exon number to transcript name to make ID
...
# For genes, extract gene from group and set Parent to NA
